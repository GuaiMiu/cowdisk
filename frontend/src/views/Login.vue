  ...
  <div class="page login">
    <div class="login-grid">
      <div class="login-hero card">
        <div class="hero-tag">笨牛后台</div>
        <h1>管理，更像是掌控节奏。</h1>
        <p>
          集中管理用户、角色、菜单和网盘文件。安全、清晰、可追踪，让日常运维更轻松。
        </p>
        <div class="hero-metrics">
          <div>
            <div class="metric-label">系统状态</div>
            <div class="metric-value">稳定运行</div>
          </div>
          <div>
            <div class="metric-label">数据节点</div>
      ...
      <form class="login-card card" @submit.prevent="submit">
        <div class="card-head">
          ...
          <div class="subtitle">登录后进入控制台</div>
        </div>
        <div class="field">
          <label>用户名</label>
