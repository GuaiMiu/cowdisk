...
class ResponseModel[T](BaseModel):
    code: Annotated[int, Field(default=200, description="Response code")]
    msg: Annotated[str, Field(default="Success", description="Response message")]
    data: Union[T, list[T], None] = Field(default=None, description="Response data")
    time: datetime = Field(default_factory=datetime.now, description="Response time")
